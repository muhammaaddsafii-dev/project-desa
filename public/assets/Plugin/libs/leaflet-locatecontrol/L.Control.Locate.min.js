...
!(function (t, i) {
  ...
  var o = function (i, o, t) {
    ...
    t = h.Marker.extend({
      initialize: function (t, i) {
        h.Util.setOptions(this, i), (this._latlng = t), this.createIcon();
      },
      createIcon: function () {
        var t = this.options,
          i = "";
      ...
      setStyle: function (t) {
        h.Util.setOptions(this, t), this.createIcon();
      },
    }),
    e = t.extend({
      initialize: function (t, i, o) {
        h.Util.setOptions(this, o),
          (this._latlng = t),
          (this._heading = i),
          this.createIcon();
      },
    ...
    n = h.Control.extend({
      options: {
        ...
        createButtonCallback: function (t, i) {
          ...
          return (
            ...
            { link: o, icon: h.DomUtil.create(i.iconElementTag, i.icon, o) }
          );
        },
      ...
      initialize: function (t) {
        for (var i in t)
          "object" == typeof this.options[i]
            ? h.extend(this.options[i], t[i])
            : (this.options[i] = t[i]);
        (this.options.followMarkerStyle = h.extend(
          {},
          this.options.markerStyle,
          this.options.followMarkerStyle
        )),
          (this.options.followCircleStyle = h.extend(
            {},
            this.options.circleStyle,
            this.options.followCircleStyle
          )),
          (this.options.followCompassStyle = h.extend(
            {},
      ...
      onAdd: function (t) {
        var i = h.DomUtil.create(
          "div",
          "leaflet-control-locate leaflet-bar leaflet-control"
        );
        (this._layer = this.options.layer || new h.LayerGroup()),
          this._layer.addTo(t),
          (this._event = void 0),
        ...
        return (
          (this._link = o.link),
          (this._icon = o.icon),
          h.DomEvent.on(this._link, "click", h.DomEvent.stopPropagation)
            .on(this._link, "click", h.DomEvent.preventDefault)
            .on(this._link, "click", this._onClick, this)
            .on(this._link, "dblclick", h.DomEvent.stopPropagation),
      ...
      _drawMarker: function () {
        ...
        if (this.options.drawCircle) {
          var e = this._isFollowing()
            ...
            : this.options.circleStyle;
          this._circle
            ? this._circle.setLatLng(s).setRadius(o).setStyle(e)
            : (this._circle = h.circle(s, o, e).addTo(this._layer));
        }
        if (
        ...
        this.options.showPopup &&
          ...
          this._marker &&
          this._marker
            .bindPopup(h.Util.template(a, { distance: t, unit: i }))
            ._popup.setLatLng(s),
          this.options.showPopup &&
            a &&
            this._compass &&
      ...
      _setCompassHeading: function (t) {
        !isNaN(parseFloat(t)) && isFinite(t)
          ? ((t = Math.round(t)),
            ...
            h.Util.requestAnimFrame(this._drawCompass, this))
          : (this._compassHeading = null);
      },
      ...
      _cleanClasses: function () {
        h.DomUtil.removeClass(this._container, "requesting"),
          h.DomUtil.removeClass(this._container, "active"),
          h.DomUtil.removeClass(this._container, "following"),
          s(this._icon, this.options.iconLoading),
          i(this._icon, this.options.icon);
      },
  ...
  return (
    (h.control.locate = function (t) {
      return new h.Control.Locate(t);
    }),
    n
  );
}, window);
