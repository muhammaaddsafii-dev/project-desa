...
@section('content')
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="dataModalLabel">
                        <b>DETAIL DATA SARANA DAN PRASARANA</b>
                    </h5>
                ...
                <div class="modal-body">
                    <form id="editResidentForm" class="row g-3" method="POST">
                        ...
                        <div class="col-md-6">
                            <label for="jenis" class="form-label"><b>Jenis</b></label>
                            <input type="text" class="form-control" id="jenis" name="jenis" />
                        </div>
                        <div class="col-md-6">
                            <label for="objek" class="form-label"><b>Objek</b></label>
                            <input type="text" class="form-control" id="objek" name="objek" />
                        </div>
                        <div class="col-md-6">
                            <label for="toponim" class="form-label"><b>Toponim</b></label>
    ...
    <div class="modal fade" id="gambarModal" tabindex="-1" aria-labelledby="gambarModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="text" class="img-fluid" style="display: block; margin: auto">
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        var icons = {
            sosial: L.icon({
                iconUrl: "{{ 'assets/map-assets/WebGIS/assets/img/legend/kantorpemerintah.png' }}",
                iconSize: [22, 22],
            }),
            kantor: L.icon({
                iconUrl: "{{ 'assets/map-assets/WebGIS/assets/img/legend/industri.png' }}",
                iconSize: [22, 22],
            }),
            pendidikan: L.icon({
                iconUrl: "{{ 'assets/map-assets/WebGIS/assets/img/legend/pendidikan.png' }}",
                iconSize: [22, 22],
            }),
            pdj: L.icon({
                iconUrl: "{{ 'assets/map-assets/WebGIS/assets/img/legend/pdj.png' }}",
                iconSize: [22, 22],
            }),
            peribadatan: L.icon({
                iconUrl: "{{ 'assets/map-assets/WebGIS/assets/img/legend/masjid.png' }}",
                iconSize: [22, 22],
            }),
            rth: L.icon({
                iconUrl: "{{ 'assets/map-assets/WebGIS/assets/img/legend/makam.png' }}",
                iconSize: [22, 22],
            }),
            jalan: L.icon({
        ...
        var fasum = L.geoJson(null, {
            pointToLayer: function(feature, latlng) {
                ...
                if (feature.properties["Jenis Fasum"] === "Fasilitas Sosial") {
                    ...
                    icon = icons.kantor;
                } else if (feature.properties["Jenis Fasum"] === "Ruang Terbuka Hijau") {
                    icon = icons.rth;
                } else if (feature.properties["Jenis Fasum"] === "Pendidikan") {
                    icon = icons.pendidikan;
                } else if (feature.properties["Jenis Fasum"] === "Perdagangan dan Jasa") {
                    icon = icons.pdj;
                } else {
            ...
            onEachFeature: function(feature, layer) {
                ...
                if (feature.properties["Gambar"]) {
                    content +=
                        ...
                        "' alt='Gambar Fasum' style='max-width:100%; max-height:200px; display: block; margin: 0 auto;'>" +
                        "</div>";
                }
                ...
                layer.on({
                    ...
                    mouseover: function(e) {
                        layer.bindTooltip(feature.properties["Jenis Fasum"], {
                            direction: "center"
                        }).openTooltip();
                    },
                    mouseout: function(e) {
                        fasum.resetStyle(layer); // Mengembalikan style layer ke style awal
        ...
        map.getPane("pane_tanahdesa").style.zIndex = 401;
        map.getPane(
        ...
        var addGroupedLayerControl = (layers) => {
            var groupedOverlays = {
                "Fasilitas Umum": {
                    ...
                    [createLayerLabel(icons.pendidikan, "Pendidikan")]: layers.pendidikan,
        ...
        L.control
            .search({
                layer: fasum,
                textPlaceholder: "Cari Fasilitas Umum...",
                initial: false,
                zoom: 20,
                propertyName: "Nama Fasum",
                buildTip: function(text, val) {
                    var type = val.layer.feature.properties["Jenis Fasum"];
                    return (
                        '<a href="#" class="' +
                        type +
                        '">' +
        ...
        function populateForm(properties) {
            ...
            document.getElementById('jenis').value = properties['Jenis Fasum'];
            document.getElementById('objek').value = properties['Objek'];
            document.getElementById('toponim').value = properties['Nama Fasum'];
            ...
            form.action = "/peta-sarana-prasarana-admin/" + properties['id']; // This points to the route created above
        }
    </script>
@endsection
